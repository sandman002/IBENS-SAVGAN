...
from model_ablation2 import Generator
from model_ablation2 import Discriminator
from model_ablation2 import Discriminator2
	...
	def train(self):
		...
		for step in range(start, self.total_step):
			...
			for i in range(0,self.d_iters):
				data_iter = iter(self.data_loader)
				real_vid = input_A.copy_(next(data_iter)['A'])
